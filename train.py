...
params = {"actor_params": actor_params, "b_size": 64,
          ...
          "noise_params": noise_params, "memory_size": 500, "tracelen":10}
...
train_rollouts = RolloutGenerator(env, agent, {"render": 1, 
                                               "n_episodes": 100000,
                                               "periodic_ckpt": 50,
                                               "tracelen": agent.tracelen,
                                               "train_cycles_per_ts":10})
# eval_rollouts = RolloutGenerator(env, agent, {"render": 1,
#                                               "n_episodes": 20,
#                                               "save_best": True}, True)
